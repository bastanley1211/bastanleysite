    ...
    <animated.div style={props}>
      <div className="container">
        <div className="col-12 text-center mt-1 mb-4">
          <h3>Learn About the "Why?"</h3>
        </div>
        <div className="row mx-auto">
          <div className="col-md-3 col-lg-3 my-auto">
            <img
              src="../../public/img/FineLine-9_Original.jpg"
              id="self-image"
              className="img-fluid"
          ...
          <div class="col-md-9 col-lg-6 mt-3 my-auto" id="about-p">
            <p>
              ...
              learning how to interact with web-builders. When the whim hit me,
              I would often build a site (HTML/CSS) and try and publish it for
              free somewhere since I was too young to have that kind of money
              😂.
            </p>
            <p>
            ...
            <p>
              ...
              to put all my focus into solving a problem. I enjoy when I can be
              a part of a create and collaborative team. I have realized that
          ...
          <div
            className="col-12 col-sm-9 col-md-6 col-lg-3 p-3 my-auto mx-auto"
            id="tech"
          >
            <h5>Technologies:</h5>
